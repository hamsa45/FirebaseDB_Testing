...
public class camOutlineEffect : MonoBehaviour
{
	public static camOutlineEffect Instance { get; private set; }

	private readonly List<Outlinetest> outlines = new List<Outlinetest>();
	...
	public void OnPreRender()
	{
		...
		foreach (Outlinetest outline in outlines)
		{
	...
	{
		Outlinetest[] o = FindObjectsOfType<Outlinetest>();
		if (autoEnableOutlines)
		{
			foreach (Outlinetest oL in o)
			{
				oL.enabled = false;
				oL.enabled = true;
			}
	...
	public void AddOutline(Outlinetest outline)
		 => outlines.Add(outline);

	public void RemoveOutline(Outlinetest outline)
